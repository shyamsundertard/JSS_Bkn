...
const Board = () => {
  return (
    <div className="flex-grow md:mx-20 md:my-10 m-5">
      <h2 className="text-2xl font-semibold text-center mb-8  text-red-500">
      ...
      <h3 className="text-xl font-semibold mb-4  text-red-500">प्रबंध मंडल के गैर कार्यालयी सदस्य (NON OFFICIAL MEMBERS)</h3>
      <table className="min-w-full border-collapse border border-gray-200 table-fixed">
        <thead>
          <tr>
            <th className="border border-gray-300 ">क्र.</th>
            <th className="border border-gray-300 ">प्रबंध मंडल के सदस्य महानुभाव</th>
            <th className="border border-gray-300 py-2">पद</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="border border-gray-300 p-2">चेयरमैन</td>
          </tr>
          <tr>
            ...
            <td className="border border-gray-300 p-2">वाईस चेयरमैन</td>
          </tr>
          <tr>
            ...
            <td className="border border-gray-300 p-2">सदस्य</td>
          </tr>
          <tr>
      ...
      <h3 className="text-xl font-semibold mb-4 mt-8  text-red-500">प्रबंध मंडल के कार्यालयी सदस्य (OFFICIAL MEMBER)</h3>
