...
const Introduction = () => {
  return (
    <div className="p-6 md:p-12 max-w-4xl mx-auto">
      {/* Title Section */}
      <h1 className="text-2xl md:text-4xl font-bold text-center mb-6" style={{ color: '#FFA500' }}>
      ...
      <div className="space-y-6">
        {/* परिचय Card */}
        <div className="bg-white shadow-lg rounded-lg p-4 border-l-4 border-[#FFA500]">
